...
//       <div className='flex h-[1500px] items-end justify-center pb-12'>
//         <InView
...
export function InViewImagesGrid() {
  return (
    <div className='h-full w-full overflow-auto'>
      ...
      <div className='mt-10 mb-20 py-6 text-center text-sm'>Scroll down</div>
      ...
      <div className='flex min-h-screen items-end justify-center pb-12'>
        ...
        >
          ...
          <div className='columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-4 px-4 sm:px-8'>
            {[
              'https://images.beta.cosmos.so/e5ebb6f8-8202-40ec-bc70-976f81153501?format=jpeg',
              'https://images.beta.cosmos.so/1b6f1bee-1b4c-4035-9e93-c93ef4d445e1?format=jpeg',
              'https://images.beta.cosmos.so/9968a6cf-d7f6-4ec9-a56d-ac4eef3f8689?format=jpeg',
